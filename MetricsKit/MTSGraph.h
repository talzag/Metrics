...
/**
 ...
 @param completionHandler An optional completion handler that will be called when all queries have finished executing. The only argument is an NSError object that will be non-nil if there was an error executing any of the queries.
 */
- (void)executeQueriesWithHealthStore:(nonnull HKHealthStore *)healthStore
